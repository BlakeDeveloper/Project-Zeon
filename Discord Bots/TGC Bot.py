...
client = commands.AutoShardedBot(command_prefix = 't.', case_insensitive = True, shard_count = 1)
...
async def invite(ctx):
    embed = discord.Embed(title = "Invite me to your server!", description = "Invite link: [here](https://discord.com/api/oauth2/authorize?client_id=986730397968785518&permissions=8&scope=bot%20applications.commands)", color = 0x00ff00)
    await ctx.send(embed = embed)
